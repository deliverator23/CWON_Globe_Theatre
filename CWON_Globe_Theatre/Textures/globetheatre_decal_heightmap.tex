...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\paperspace\Downloads\globetheatre_decal_heightmap.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1785642040</m_ExportedTime>
	<m_ClassName text="Decal_Heightmap"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="globetheatre_decal_heightmap.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="globetheatre_decal_heightmap"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
