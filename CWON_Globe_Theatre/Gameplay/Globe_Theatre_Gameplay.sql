...
-- +1 Amenities for any City with Amphitheater or Marae
...
INSERT INTO Requirements (RequirementId, RequirementType) SELECT 'REQUIRES_CITY_HAS_MAORI_MARAE_GLOBE', 'REQUIREMENT_CITY_HAS_BUILDING' FROM Types WHERE Type="BUILDING_MARAE";

INSERT INTO RequirementArguments (RequirementId, Name, Value) SELECT 'REQUIRES_CITY_HAS_MAORI_MARAE_GLOBE', 'BuildingType', 'BUILDING_MARAE' FROM Types WHERE Type="BUILDING_MARAE";
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) SELECT 'REQUIREMENTS_CITY_HAS_AMPHITHEATER_GLOBE', 'REQUIRES_CITY_HAS_MAORI_MARAE_GLOBE' FROM Types WHERE Type="BUILDING_MARAE";
