...
VALUES		
			('GREATWORK_CWON_JOHN_DONNE_1',	'YIELD_CULTURE',	3),
			('GREATWORK_CWON_JOHN_DONNE_2',	'YIELD_CULTURE',	3),
			('GREATWORK_CWON_MOLIERE_1',	'YIELD_CULTURE',	3),
			('GREATWORK_CWON_MOLIERE_2',	'YIELD_CULTURE',	3),
			('GREATWORK_CWON_DANTE_1',	'YIELD_CULTURE',	3),
			('GREATWORK_CWON_DANTE_2',	'YIELD_CULTURE',	3);